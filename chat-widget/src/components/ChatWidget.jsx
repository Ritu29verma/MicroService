...
export default function ChatWidget({ orgId }) {
  ...
  useEffect(() => {
    const eventName = `ORG_VERIFIED_${orgId}`;
  ...
  return (
    <>
      <div
        ...
        className="fixed bottom-5 right-5 w-16 h-16 flex items-center justify-center rounded-full cursor-pointer z-[99999] text-white shadow-lg"
